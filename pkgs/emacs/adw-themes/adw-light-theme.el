;;; adw-light-theme.el --- inspired by Adwaita -*- lexical-binding: t; no-byte-compile: t; -*-
;;
;;; Commentary:
;;
;; Light theme based on the Adwaita design language.
;;
;;; Code:
...
(defgroup adw-light-theme nil
  "Options for the `adw-light' theme."
  :group 'doom-themes)

(defcustom adw-light-brighter-modeline nil
  "If non-nil, more vivid colors will be used to style the mode-line."
  :group 'adw-light-theme
  :type 'boolean)

(defcustom adw-light-brighter-comments nil
  "If non-nil, comments will be highlighted in more vivid colors."
  :group 'adw-light-theme
  :type 'boolean)

(defcustom adw-light-padded-modeline doom-themes-padded-modeline
...
(def-doom-theme adw-light
  "A light theme inspired by the Adwaita design language."
  (;; These should represent a spectrum from bg to fg, where base0 is a starker
   ;; bg and base8 is a starker fg. For example, if bg is light grey and fg is
   ;; dark grey, base0 should be white and base8 should be black.

   ;; name        default   256           16
   (base0      '("#deddda" "#dadada"     "white"        ))
   (base1      '("#c0bfbc" "#c0c0c0"     "brightblack"  ))
   (base2      '("#9a9996" "#9e9e9e"     "brightblack"  ))
   (base3      '("#77767b" "#767676"     "brightblack"  ))
   (base4      '("#5e5c64" "#5f5f5f"     "brightblack"  ))
   (base5      '("#504e55" "#4e4e4e"     "brightblack" ))
   (base6      '("#3d3846" "#3a3a3a"     "brightblack"  ))
   (base7      '("#241f31" "#262626"     "brightblack"  ))
   (base8      '("#000000" "#000000"     "black"        ))

   (bg         '("#fcfcfc" "#ffffff"     "white"  ))
   (fg         '("#504e55" "#4e4e4e"     "black"  ))

   ;; These are off-color variants of bg/fg, used primarily for `solaire-mode',
   ;; but can also be useful as a basis for subtle highlights (e.g. for hl-line
   ;; or region), especially when paired with the `doom-darken', `doom-lighten',
   ;; and `doom-blend' helper functions.
   (bg-alt     '("#303030" "#303030"     "black"        ))
   ...
   (selection      dark-blue)
   (builtin        "#62a0ea")
   (comments       (if adw-light-brighter-comments dark-cyan base5))
   (doc-comments   (doom-lighten (if adw-light-brighter-comments dark-cyan base5) 0.25))
   (constants      violet)
   (functions      blue)
   (keywords       orange)
   (methods        orange)
   ...
   (modeline-bg              (if adw-light-brighter-modeline
                                 (doom-darken blue 0.45)
                               bg-alt))
   (modeline-bg-alt          (if adw-light-brighter-modeline
   ...
   (-modeline-pad
    (when adw-light-padded-modeline
      (if (integerp adw-light-padded-modeline) adw-light-padded-modeline 4))))
  ...
  ((cursor :background base6)
   ...
   ((font-lock-comment-face &override)
    :background (if adw-light-brighter-comments (doom-lighten bg 0.05)))
   ...
   (mode-line-emphasis :foreground (if adw-light-brighter-modeline base8 highlight))
   ...
   ((diff-removed &override) :foreground red1)
   ;;;; display-fill-column-indicator
   ((fill-column-indicator &override) :foreground vertical-bar-alt)
   ;;;; doom-modeline
   (doom-modeline-bar :background (if adw-light-brighter-modeline modeline-bg highlight))
...
(provide 'adw-light-theme)

;;; adw-light-theme.el ends here
